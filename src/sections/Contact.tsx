...
const Contact = () => {
  return (
    <section className="w-full mt-34 sm:mt-40 px-5 sm:px-10 md:px-14 lg:px-20 xl:px-0">
      <div className="relative max-w-6xl mx-auto bg-gray-200 border border-black/20 dark:border-white/20 rounded-xl overflow-hidden px-6 sm:px-10 py-14">

        <div className="absolute -top-35 -left-35 h-125 w-125 rounded-full dark:bg-purple-500/15 blur-[120px]" />{" "}
        <div className="absolute top-30 left-40 h-125 w-125 rounded-full dark:bg-red-500/10 blur-[120px]" />{" "}
        <div className="absolute bottom-0 right-0 h-100 w-100 rounded-full dark:bg-blue-500/10 blur-[120px]" />{" "}
        <div className="absolute inset-0 dark:bg-linear-to-br from-purple-500/5 via-transparent to-black/40" />{" "}
